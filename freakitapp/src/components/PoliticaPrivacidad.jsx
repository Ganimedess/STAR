  ...
  return (
    <div>
      <section className="textos-legales">
            ...
            <ol>
                <li>
                    <p className="text-2xl font-bold">Información al usuario</p>
                    <p>Freakit! como Responsable del Tratamiento, le informa que, según lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril, (RGPD) y en la L.O. 3/2018, de 5 de diciembre, de protección de datos y garantía de los derechos digitales (LOPDGDD), trataremos su datos tal y como reflejamos en la presente Política de Privacidad. En esta Política de Privacidad describimos cómo recogemos sus datos personales y por qué los recogemos, qué hacemos con ellos, con quién los compartimos, cómo los protegemos y sus opciones en cuanto al tratamiento de sus datos personales. Esta Política se aplica al tratamiento de sus datos personales recogidos por la empresa para la prestación de sus servicios. Si acepta las medidas de esta Política, acepta que tratemos sus datos personales como se define en esta Política. Acepta esta política de privacidad al crearse una cuenta en Freakit!.</p>
                </li>
                <li>
                    ...
                    <p>
                        ...
                        <ul>
                            ...
                            <li><b>Precisión:</b> Mantendremos sus datos personales exactos y actualizados siempre que así usted lo requiera.</li>
                            <li><b>Seguridad de los Datos:</b> Aplicamos las medidas técnicas y organizativas adecuadas y proporcionales a los riesgos para garantizar que sus datos no sufran daños, tales como divulgación o acceso no autorizado, la destrucción accidental o ilícita o su pérdida accidental o alteración y cualquier otra forma de tratamiento ilícito.</li>
                            <li><b>Conservación:</b> Conservamos sus datos personales de manera legal y apropiada y solo mientras es necesario para los fines para los que se han recopilado.</li>
                            <li><b>Las transferencias internacionales:</b>cuando se dé el caso de que sus datos vayan a ser transferidos fuera de la UE/EEE se protegerán adecuadamente.</li>
                            <li><b>Terceros:</b> El acceso y transferencia de datos personales a terceros se llevan a cabo de acuerdo con las leyes y reglamentos aplicables y con las garantías contractuales adecuadas.</li>
                            <li><b>Marketing Directo y cookies:</b> Cumplimos con la legislación aplicable en materia de publicidad y cookies.</li>
                        </ul>
                    </p>
                </li>
                <li>
                    <p className="text-2xl font-bold">Recogida y tratamiento de sus datos personales</p>
                    <p>
                        ...
                        Freakit! podrá mirar, revisar y/o contrastar las conversaciones de los usuarios en el caso de ser denunciados ya sea por: acoso, insultos, amenazas o cualquier comportamiento no aceptado en las reglas de la comunidad.
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p className="text-2xl font-bold">Comunicación de datos personales</p>
                    <p>Los datos pueden ser comunicados a empresas relacionadas con Freakit! para la prestación de los diversos servicios en calidad de Encargados del Tratamiento. La empresa no realizará ninguna cesión, salvo por obligación legal.</p>
                </li>
                <li>
                    ...
                    <p>
                        ...
                        Si ha otorgado su consentimiento para alguna finalidad concreta, tiene derecho a retirar el consentimiento otorgado en cualquier momento, sin que ello afecte a la licitud del tratamiento basado en el consentimiento previo a su retirada. Puede ejercer estos derechos enviando comunicación, motivada y acreditada, a freakitapp@gmail.com También tiene derecho a presentar una reclamación ante la Autoridad de control competente (<a href="www.aepd.es" target="_blank">www.aepd.es</a>) si considera que el tratamiento no se ajusta a la normativa vigente.
                    </p>
                </li>
                <li>
                    <p className="text-2xl font-bold">Información legal</p>
