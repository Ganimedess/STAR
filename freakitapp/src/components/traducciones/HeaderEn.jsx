        ...
        <div>
          <ul className="hidden md:flex">
            <li className="dropdown dropdown-hover">
              <label tabIndex={0} className="btn btn-ghost hover:bg-base-100 text-primary font-semibold text-lg normal-case">Personalities</label>
            ...
            <li className="dropdown dropdown-hover pl-3">
              <label tabIndex={0} className="btn btn-ghost hover:bg-base-100 text-primary font-semibold text-lg normal-case">Help</label>
              <ul tabIndex={0} className="dropdown-content rounded-md menu p-2 shadow bg-white">
                <li><Link to="/en/help">Help</Link></li>
                <li><Link to="/en/faq">Frequently asked questions</Link></li>
                <li><Link to="/en/safety-tips">Safety tips</Link></li>
              </ul>
            </li>
            <li className="dropdown dropdown-hover pl-3">
              <label tabIndex={0} className="btn btn-ghost hover:bg-base-100 text-primary font-semibold text-lg normal-case">Contact</label>
              <ul tabIndex={0} className="dropdown-content rounded-md menu p-2 shadow bg-white">
            ...
            <li className="dropdown dropdown-hover pl-3">
              <label tabIndex={0} className="btn btn-ghost bg-base-100 hover:bg-base-200 text-primary font-semibold text-lg normal-case">Download</label>
              <ul tabIndex={0} className="dropdown-content rounded-md menu p-2 shadow bg-white">
