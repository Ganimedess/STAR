...
const Work = () => {
    ...
    <section id="work" className="flex items-start bg-slate-900">
        <div className=" grid grid-cols-12 gap-4 w-full py-24 max-md:py-24">
            ...
            <div className="col-start-2 lg:col-start-3 col-span-10 lg:col-span-9  grid grid-cols-8 gap-2 md:gap-12 p-3 lg:p-0">
                ...
                <a href='https://www.behance.net/said-sellam' rel='noreferrer' target='_blank' className={`${eyeOpen ? 'eyeOpen' : 'eyeClosed'} round10 project text-slate-900 col-span-4 bg-[#ffffffe0] hover:bg-white overflow-hidden`} onMouseDown={closeEye} onMouseUp={openEye}>
