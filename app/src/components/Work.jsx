        ...
        <div id="work" className="grid grid-cols-12 gap-4 w-full">
            <div className="col-start-2 lg:col-start-3 col-span-10 lg:col-span-8 grid grid-cols-8 gap-4 gap-y-9">
                ...
                <div className="text-left md:text-center col-span-full grid gap-y-12 mt-5 relative">
                    ...
                    <div className="proyect proyect-freakit flex flex-col md:flex-row justify-center items-start md:items-end flex-wrap">
                        <h6 className="text-5xl md:text-6xl font-bold block px-2">Freakit!</h6>
                        <span className="mt-3 md:mt-0 text-xl md:ml-3 px-2 pt-8">Web design for a dating app</span>
                        <img src={freakitThumbnail} alt="preview web Freakit!" className='proyectThumb absolute' />
                    </div>
                    </Link>
                    <Link to={'/work/elRoble'}>
                    <div className="proyect proyect-roble flex flex-col md:flex-row justify-center items-start md:items-end flex-wrap">
                        <h6 className="text-5xl md:text-6xl font-bold block px-2">El Roble</h6>
                        <span className="mt-3 md:mt-0 text-xl md:ml-3 px-2 pt-8">Alternative therapy center website</span>
                        <img src={elRobleThumbnail} alt="preview web el Roble" className='proyectThumb absolute' />
                    </div>
                    </Link>
                </div>
            </div>
