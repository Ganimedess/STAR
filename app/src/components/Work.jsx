  ...
  return (
    <section className="h-100 flex items-start min-h-[60vh] mt-24">
        <div id="work" className="grid grid-cols-12 gap-4 w-full">
            <div className="col-start-2 lg:col-start-3 col-span-10 lg:col-span-8 grid grid-cols-8 gap-4">
                <div className="col-span-full lg:col-span-3">
                    <p className="text-xl text-slate-400 ml-2">Selected projects:</p>
                </div>
                <div className="text-left md:text-center col-span-full grid gap-y-12 mt-5 relative">
                    ...
                    <div className="proyect proyect-freakit max-md:relative">
                        <span className="flex flex-col md:flex-row items-start md:items-end flex-wrap">
                            ...
                            <span onMouseLeave={hoverOut} onMouseEnter={hoverIn} className="mt-3 md:mt-0 text-3xl md:pl-3 px-2 mim-md:pt-8">Web design for a dating app</span>
                        </span>
                    ...
                    <div className="proyect proyect-roble max-md:relative">
                        <span className="flex flex-col md:flex-row items-start md:items-end flex-wrap">
                            ...
                            <span onMouseLeave={hoverOut} onMouseEnter={hoverIn} className="mt-3 md:mt-0 text-3xl md:pl-3 px-2 mim-md:pt-8">Alternative therapy center website</span>
                        </span>
