...
const Cabecera = () => {
  return (
    <section id="cabecera" className="flex flex-wrap items-center min-h-[100vh] pt-24 pb-12">
        <div className="aparece grid grid-cols-12 gap-4 w-full">
            <div className="col-start-2 lg:col-start-3 col-span-10 lg:col-span-9 grid grid-cols-9 gap-4 gap-y-9">
                ...
                <div className="col-span-full lg:col-span-3 2xl:col-span-4 lg:col-start-7 2xl:col-start-6 mt-6 lg:mt-0 max-h-[80vh] overflow-hidden">
                    <img className="foto-cabecera round10" src={foto} alt="self portrait" />
                </div>
            </div>
        </div>
